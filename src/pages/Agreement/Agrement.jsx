...
function Agreement() {
    ...
    <div className="flex items-start">
      ...
      <div className="ml-3">
        <h3 className="text-sm font-medium text-yellow-800">
          Important: Review Contract Before Proceeding
        </h3>
        <div className="mt-2 text-sm text-yellow-700">
          <p>
            Please carefully review the entire contract above. You must read and understand 
            the terms before proceeding to payment. The payment button will remain disabled 
            until you have previewed the contract.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="flex justify-center gap-4 mb-8">
    <button
      ...
      className="btn btn-primary px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
    >
      {showPdfPreview ? "Hide Contract" : "View Contract"}
    </button>
  </div>
  
  {/* PDF Preview - Always show when toggled */}
  {showPdfPreview && (
